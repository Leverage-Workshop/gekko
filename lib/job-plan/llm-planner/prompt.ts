 ...
 * and more likely to trigger a countertrend trade". An unreached important
 * level now carries BOTH reads (gate), and the more stacked it is the more
 * the fail is the first read. The payload names each band's importance.
 */
export const LLM_PLANNER_REVISION = 'llm-planner/2026-09-07.3'
