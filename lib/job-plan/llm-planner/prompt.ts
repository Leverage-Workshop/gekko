 ...
 */
/**
 * 2026-09-07 late (feat-151): "I don't think dedicating a play to the trend
 * line is necessary. It can just be assumed that is a two-way play." The
 * line is drawn as the frame and never written as a play; the slots go to
 ...
 *     all." Both are destination-only in the payload (R2), never join a
 *     band, and the validator rejects a play there; the prompt says so in
 *     the play-selection rule.
 *
